...
define('DGPTM_SESSION_DISPLAY_VERSION', '1.0.0');
...
class DGPTM_Session_Display {
    ...
    private function __construct() {
        // Zentrale Zoho-Auth: Backstage-Scopes registrieren
        add_filter('dgptm_zoho_required_scopes', function( $scopes ) {
            $scopes['Session Display'] = [
                'ZohoBackstage.events.READ',
                'ZohoBackstage.portals.READ',
            ];
            return $scopes;
        });
    ...
    public function add_admin_menu() {
        ...
        add_submenu_page(
            'dgptm-session-display',
            'Raumzuordnung - Session Display',
            'Raumzuordnung',
            'manage_options',
            'dgptm-session-display-rooms',
            [$this, 'rooms_page']
        );
    ...
    public function rooms_page() {
        ...
        $admin_settings = new DGPTM_Session_Display_Admin();
        $admin_settings->render_rooms_page();
    }

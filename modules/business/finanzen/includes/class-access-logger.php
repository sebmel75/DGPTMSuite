<?php
/**
 * Access Logger - Protokolliert Zugriffe auf Finanzberichte.
 *
 * Portiert von finanzbericht/class-access-logger.php.
 * BEHAELT den gleichen Tabellennamen (wp_dgptm_fb_access_log)
 * um vorhandene Log-Daten zu erhalten.
 *
 * @package DGPTM_Finanzen
 */
if (!defined('ABSPATH')) exit;

class DGPTM_FIN_Access_Logger {

        ...
        <div class="dgptm-freigabe-feedback-banner">
            ...
            <div>
                ...
                <ul class="dgptm-freigabe-feedback-list">
                    ...
                    <li><strong>Externe Gutachter:</strong> Token-basierter Zugang fuer Nicht-Mitglieder. &rarr; <em>Abschnitt 2 (Hinweis-Box) + Bewertungs-Demo</em> <span class="dgptm-badge-umgesetzt">eingearbeitet</span></li>
                    ...
                    <li><strong>Expose-Leitfaden:</strong> 1-seitiges Gliederungsdokument mit Pflichtstruktur (Titel, Einleitung, Zielsetzung, Hintergrund, Methodik, Relevanz, Zeitplan, Literatur). Bezug zu Bewertungskriterien A-D. &rarr; <em>Abschnitt 5</em> <span class="dgptm-badge-umgesetzt">eingearbeitet</span></li>
                    ...
                    <li><strong>ORCID-ID automatisch abfragen:</strong> Technisch umgesetzt. Wird im Bewerbungsformular bei Eingabe der ORCID-ID automatisch Name, Institution und E-Mail abgerufen. &rarr; <em>Bewerbungsformular + Bewertungsseite (ORCID-Link)</em> <span class="dgptm-badge-umgesetzt">eingearbeitet</span></li>
                    <li><strong>Demo-Version:</strong> Funktionsfaehige Demo mit fiktiver Bewerbung. Bewertungs-Demo direkt in diesem Dokument aufrufbar (Button unten). Gutachter-Flow mit Token, Auto-Save, Live-Score und Danke-Seite. &rarr; <em>Bewertungs-Demo Abschnitt + /karriere/stipendien/gutachten/</em> <span class="dgptm-badge-umgesetzt">eingearbeitet</span></li>
